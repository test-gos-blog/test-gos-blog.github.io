...
extra.categories = ["news", "android-17"]
+++
...
Our latest release is available in the alpha and beta channels. It will not go to the stable channel because we're currently building a new release with some fixes, including an RCS fix that is affecting many users.
